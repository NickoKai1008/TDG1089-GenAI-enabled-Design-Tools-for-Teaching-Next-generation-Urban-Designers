...
The checks verify canonical phase language, evidence labels, public-asset boundaries, rating-record behaviour, CSV output, relative paths and required delivery documents.
