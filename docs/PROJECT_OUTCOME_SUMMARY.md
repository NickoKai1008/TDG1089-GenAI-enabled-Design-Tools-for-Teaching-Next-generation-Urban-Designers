...
## Project evaluation and student feedback

MUDP2020 Values of Urban Design served as the main teaching testbed for the TDG-supported tools and pedagogical modules. The March-May 2026 Student Feedback on Teaching and Learning (SFTL) exercise covered 57 enrolled students and received 45 forms, giving a response rate of 79%.

All seven reported 2025-26 SFTL dimensions scored between 92.2 and 95.0. Compared with 2024-25, the scores increased by 7.2-14.2 points; each dimension also exceeded its corresponding departmental average by 1.2-4.4 points. Anonymous comments highlighted the range of contemporary methods, practical teaching, urban imagery and data visualisation, research skills, creativity and manageable workload.

The 2026-27 implementation will extend this course-level evidence through a common assessment rubric, consented student feedback and follow-up measures that examine longer-term learning gains and transfer into later studio and dissertation work.
...
- a project-evaluation section presenting year-on-year SFTL results, departmental comparisons and anonymous qualitative feedback;
